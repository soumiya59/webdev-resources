...
export default function app({logo,name,desc,url}:props){
    return(
        ...
        className='cursor-pointer w-full shadow-md flex items-center p-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 bg-slate-50 mb-2 text-darkblue'> 
